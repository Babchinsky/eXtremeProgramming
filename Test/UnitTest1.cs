...
namespace Test
{
    ...
    public class RomanNumberTest
    {
        ...
        {
            RomanNumber rn = RomanNumber.Parse("asdfasdf");
            Assert.IsNotNull(rn);
        ...
        {
            Assert.AreEqual(1, RomanNumber.Parse("5").Value, "Expected value for 'I' is 1.");
        ...
        {
            Assert.AreEqual(4, RomanNumber.Parse("III").Value, "Expected value for 'III' is 3.");
